...
public class Human extends Entity {
    ...
    // Specific attributes for humans could be added, e.g., age, social behaviors
    // For simplicity, we mainly use attributes from the Entity class for now.
    ...
    public Human(Position position, double immunity) {
        super(position,
              ...
              1,         // Human movement range (e.g., 1-2 fields)
              2,         // Human infection range (e.g., 1-2 fields)
    ...
    // Methods like move or tryToInfectOthers can be overridden
    // if humans are to have specific behaviors.
}